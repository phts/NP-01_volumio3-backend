...
CorePlayQueue.prototype.removeItemsAfterIndex = async function (index) {
...
CorePlayQueue.prototype.addQueueItems = function (arrayItems, position = this.arrayQueue.length + 1) {
  var self = this
  var defer = libQ.defer()
