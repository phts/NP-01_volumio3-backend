  ...
  try {
    if (req.query.cmd == 'play') {
      ...
      if (req.query.N == undefined) {
        ...
        self
          .logStart('Client requests Volumio play at index ' + N)
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Volumio toggle')
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Volume ' + VolumeInteger)
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Volumio Play Playlist ' + playlistName)
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Position ' + position)
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Repeat ' + value)
        .then(function () {
          if (value != undefined) {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Random ' + value)
        .then(function () {
          if (value != undefined) {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Start Airplay PlaybackRoutine')
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests Stop Airplay Playback')
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests AirplayActive')
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('Client requests AirplayInactive')
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('USB Audio Device Attached')
        .then(function () {
      ...
      var timeStart = Date.now()
      self
        .logStart('USB Audio Device Detached')
        .then(function () {
